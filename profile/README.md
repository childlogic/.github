...
Our first public project is [ChildLogic Format](https://github.com/childlogic/childlogic-format), or CLF.
...
- `[B] Behavior`: what the child actually did or said
- `[C] Consequence`: what happened after the behavior
- `[L] Logic Tags`: possible developmental, relational, cognitive, or contextual logic

The current public baseline is [ChildLogic Format v1.0](https://github.com/childlogic/childlogic-format/releases/tag/v1.0).
...
- Read the format: [childlogic-format](https://github.com/childlogic/childlogic-format)
- Review the tag dictionary: [TAGS.md](https://github.com/childlogic/childlogic-format/blob/main/TAGS.md)
- Use the machine-readable tag data: [logic-tags.v0.1.json](https://github.com/childlogic/childlogic-format/blob/main/data/logic-tags.v0.1.json)
